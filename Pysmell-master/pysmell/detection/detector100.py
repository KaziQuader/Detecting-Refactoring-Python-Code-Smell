...
myportion = open('result100\\portion.txt',mode='w', encoding='UTF8')
...
LongParameterList = csv.writer(open('result100\\LongParameterList.csv','w', encoding='UTF8'))
LongParameterList.writerow(['subject','open','lineno','PAR','experience-based','statistics-based','tuning machine'])
LongMethod = csv.writer(open('result100\\LongMethod.csv','w', encoding='UTF8'))
LongMethod.writerow(['subject','open','lineno','MLOC','experience-based','statistics-based','tuning machine'])
LongScopeChaining = csv.writer(open('result100\\LongScopeChaining.csv','w', encoding='UTF8'))
LongScopeChaining.writerow(['subject','open','lineno','DOC','experience-based','statistics-based','tuning machine'])
LongBaseClassList = csv.writer(open('result100\\LongBaseClassList.csv','w', encoding='UTF8'))
LongBaseClassList.writerow(['subject','open','lineno','NBC','experience-based','statistics-based','tuning machine'])
LargeClass = csv.writer(open('result100\\LargeClass.csv','w', encoding='UTF8'))
LargeClass.writerow(['subject','open','lineno','CLOC','experience-based','statistics-based','tuning machine'])
LongLambdaFunction = csv.writer(open('result100\\LongLambdaFunction.csv','w', encoding='UTF8'))
LongLambdaFunction.writerow(['subject','open','lineno','NOC','PAR','NOO','experience-based','statistics-based','tuning machine'])
LongTernaryConditionalExpression = csv.writer(open('result100\\LongTernaryConditionalExpression.csv','w', encoding='UTF8'))
LongTernaryConditionalExpression.writerow(['subject','open','lineno','NOC','NOL','experience-based','statistics-based','tuning machine'])
ComplexContainerComprehension = csv.writer(open('result100\\ComplexContainerComprehension.csv','w', encoding='UTF8'))
ComplexContainerComprehension.writerow(['subject','open','lineno','NOC','NOFF','NOO','experience-based','statistics-based','tuning machine'])
LongMessageChain = csv.writer(open('result100\\LongMessageChain.csv','w', encoding='UTF8'))
LongMessageChain.writerow(['subject','open','lineno','LMC','experience-based','statistics-based','tuning machine'])
MultiplyNestedContainer = csv.writer(open('result100\\MultiplyNestedContainer.csv','w', encoding='UTF8'))
MultiplyNestedContainer.writerow(['subject','open','lineno','LEC','DNC','NCT','experience-based','statistics-based','tuning machine'])
...
for subjectName in subjects:
	...
	mylog = open('result100\\%s\\count.txt' %subjectName,mode='w', encoding='UTF8')
